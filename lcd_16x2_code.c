/*
	This code is used to interface an LCD display 16x2 with the Tiva C series launchpad 
	TM4C1294NCPDT. The LCD is of 16x2 type having HD44780U or similar as the controller CoB (chip on board).
	The connections between the LCD and the board are described as follows:
	This code is derived from http://users.ece.utexas.edu/~valvano/arm/ 
	  ground = pin 1    Vss
